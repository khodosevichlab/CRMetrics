...
```{r}
crm <- CRMetrics$new(data.path = "/data/ExtData/CRMetrics_testdata2/", 
                     metadata = "/data/ExtData/CRMetrics_testdata2/metadata.csv", 
                     n.cores = 50)
```
...
```{r warning=FALSE}
crm$plotSummaryMetrics(comp.group = "chemistry", metrics = "samples per group", second.comp.group = "resolution")
```
...
crm$plotSummaryMetrics(comp.group = "cellranger",
                       metrics = metrics.to.plot, 
                       plot.geom = "point", 
                       stat.test = "non-parametric",
                       second.comp.group = "chemistry", 
...
crm$plotSummaryMetrics(comp.group = "num.vec",
                       metrics = metrics.to.plot, 
                       plot.geom = "point",
                       second.comp.group = "chemistry",
                       se = FALSE)
