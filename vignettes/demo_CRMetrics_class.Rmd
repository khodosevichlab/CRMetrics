...
```{r}
data_path = "/data/PD-MSA_lentiform_nucleus/counts_premrna/"
metadata_file = "/people/szr214/CRMetrics/data/metadata.csv"

crm <- CRMetrics$new(data_path = data_path, 
...
```{r}
crm$plotGeneCount(comp_group = "group")
```
